...
class TBCalendarAppearStyle: NSObject {
    ...
    override init() {
        ...
        self.headerViewDateColor = UIColor.UIColorFromRGB(rgb: 0x4F505F)
        
        self.itemHeight = 0;
        self.dateTittleFont = UIFont.systemFont(ofSize: 14)
        self.dateDescFont = UIFont.systemFont(ofSize: 14)
        self.dateTittleSelectColor = UIColor.UIColorFromRGB(rgb: 0x000000)
        self.dateTittleUnselectColor = UIColor.UIColorFromRGB(rgb: 0x000000)
        self.dateDescSelectColor = UIColor.blue
        self.dateDescUnselectColor = UIColor.purple
        self.dateBackUnselectColor = UIColor.white
        self.dateBackSelectColor = UIColor.UIColorFromRGB(rgb: 0xEEEEEE)
