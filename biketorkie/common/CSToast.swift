...
//        bottom = nil
    ...
    fileprivate func setText(_ text: String) {
        ...
        let textSize: CGSize = (text as NSString).boundingRect(with: CGSize(width: Default_max_w, height: UIScreen.main.bounds.height), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font : msgLabel.font], context: nil).size
